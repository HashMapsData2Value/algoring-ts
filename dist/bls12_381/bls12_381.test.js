...
const bls12_381_1 = require("./bls12_381");
...
describe('Ring Signature', () => {
    ...
    let keyImage;
    beforeAll(() => {
        sk = (0, bls12_381_1.generate_fe)();
        pk = (0, bls12_381_1.generate_ge)(sk);
        number_of_participants = 6;
        const pi = (0, bls12_381_1.getRandomShiftFactor)(number_of_participants);
        ring = (0, bls12_381_1.createRing)(number_of_participants, pi, pk);
        keyImage = (0, bls12_381_1.genKeyImage)(sk, pk);
        const msg_string = 'Sign this message';
        msg = new util_1.TextEncoder().encode(msg_string); // this is the message we want to sign
    });
    it('should generate and verify a ring signature', () => {
        const { signature } = (0, bls12_381_1.generate_ring_signature)(msg, sk, ring, keyImage);
        expect((0, bls12_381_1.verify_ring_signature)(msg, signature, ring, keyImage)).toBe(true);
    });
    it('should generate an avm-compatible ring signature', () => {
        const { signature } = (0, bls12_381_1.generate_ring_signature)(msg, sk, ring, keyImage);
        (0, bls12_381_1.construct_avm_ring_signature)(msg, signature, ring, keyImage);
    });
    it('should fail to verify a ring signature with a different message', () => {
        const { signature } = (0, bls12_381_1.generate_ring_signature)(msg, sk, ring, keyImage);
        const msg_string = 'Sign this message instead';
        const msg_diff = new util_1.TextEncoder().encode(msg_string);
        expect((0, bls12_381_1.verify_ring_signature)(msg_diff, signature, ring, keyImage)).toBe(false);
    });
    it('should give me expected hashtopoint', () => {
        ...
        const new_point = (0, bls12_381_1.hash_point_to_ge)(point);
    ...
    it('should produce a valid NIZK proof', () => {
        ...
        const proof = (0, bls12_381_1.NIZK_DLOG_generate_proof)(a);
        ...
        expect((0, bls12_381_1.NIZK_DLOG_verify_proof)(proof[0], proof[1], proof[2], proof[3])).toBe(true);
        const bad_proof0 = structuredClone(proof);
        bad_proof0[0][0] = bad_proof0[0][0] + 1;
        expect(() => (0, bls12_381_1.NIZK_DLOG_verify_proof)(bad_proof0[0], bad_proof0[1], bad_proof0[2], bad_proof0[3])).toThrow('bad point: equation left != right');
        const bad_proof1 = structuredClone(proof);
        bad_proof1[1][0] = bad_proof1[1][0] + 1;
        expect(() => (0, bls12_381_1.NIZK_DLOG_verify_proof)(bad_proof1[0], bad_proof1[1], bad_proof1[2], bad_proof1[3])).toThrow('bad point: equation left != right');
        const bad_proof2 = structuredClone(proof);
        bad_proof2[2][0] = bad_proof2[2][0] + 1;
        expect(() => (0, bls12_381_1.NIZK_DLOG_verify_proof)(bad_proof2[0], bad_proof2[1], bad_proof2[2], bad_proof2[3])).toThrow('bad point: equation left != right');
        const bad_proof3 = structuredClone(proof);
        bad_proof3[3][0] = bad_proof3[3][0] + 1;
        expect((0, bls12_381_1.NIZK_DLOG_verify_proof)(bad_proof3[0], bad_proof3[1], bad_proof3[2], bad_proof3[3])).toBe(false);
        expect(() => (0, bls12_381_1.NIZK_DLOG_verify_proof)(bad_proof3[0], bad_proof3[1], bad_proof3[2], new Uint8Array(32))).toThrow('expected valid scalar: 1 <= n < 52435875175126190479447740508185965837690552500527637822603658699938581184513, got 0');
    });
});
