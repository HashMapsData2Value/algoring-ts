...
describe('Ring Signature', () => {
    ...
    let keyImage;
    beforeAll(() => {
        sk = (0, ring_1.generate_fe)();
        pk = (0, ring_1.generate_ge)(sk);
        number_of_participants = 6;
        const pi = (0, ring_1.getRandomShiftFactor)(number_of_participants);
        ring = (0, ring_1.createRing)(number_of_participants, pi, pk);
        keyImage = (0, ring_1.genKeyImage)(sk, pk);
    ...
    it('should generate and verify a ring signature', () => {
        const { signature } = (0, ring_1.generate_ring_signature)(msg, sk, ring, keyImage);
        expect((0, ring_1.verify_ring_signature)(msg, signature, ring, keyImage)).toBe(true);
    });
    it('should generate an avm-compatible ring signature', () => {
        const { signature } = (0, ring_1.generate_ring_signature)(msg, sk, ring, keyImage);
        (0, ring_1.construct_avm_ring_signature)(msg, signature, ring, keyImage);
    });
    it('should fail to verify a ring signature with a different message', () => {
        ...
        expect((0, ring_1.verify_ring_signature)(msg_diff, signature, ring, keyImage)).toBe(false);
    });
    it('should give me expected hashtopoint', () => {
        ...
        const new_point = (0, ring_1.hash_point_to_ge)(point);
        expect(new_point).toStrictEqual(new Uint8Array([
            143, 205, 156, 80, 48, 87, 140, 252, 22,
            156, 250, 71, 228, 133, 49, 209, 171, 69,
            53, 56, 102, 168, 255, 233, 205, 220, 196,
            9, 81, 238, 208, 205, 237, 152, 76, 201,
            167, 192, 185, 81, 241, 168, 190, 223, 17,
            163, 211, 191
        ]));
    });
    it('should produce a valid NIZK proof', () => {
        ...
        const proof = (0, ring_1.NIZK_DLOG_generate_proof)(a);
        ...
        expect((0, ring_1.NIZK_DLOG_verify_proof)(proof[0], proof[1], proof[2], proof[3])).toBe(true);
        const bad_proof0 = structuredClone(proof);
        bad_proof0[0][0] = bad_proof0[0][0] + 1;
        expect(() => (0, ring_1.NIZK_DLOG_verify_proof)(bad_proof0[0], bad_proof0[1], bad_proof0[2], bad_proof0[3])).toThrow('bad point: equation left != right');
        const bad_proof1 = structuredClone(proof);
        bad_proof1[1][0] = bad_proof1[1][0] + 1;
        expect(() => (0, ring_1.NIZK_DLOG_verify_proof)(bad_proof1[0], bad_proof1[1], bad_proof1[2], bad_proof1[3])).toThrow('bad point: equation left != right');
        const bad_proof2 = structuredClone(proof);
        bad_proof2[2][0] = bad_proof2[2][0] + 1;
        expect(() => (0, ring_1.NIZK_DLOG_verify_proof)(bad_proof2[0], bad_proof2[1], bad_proof2[2], bad_proof2[3])).toThrow('bad point: equation left != right');
        const bad_proof3 = structuredClone(proof);
        bad_proof3[3][0] = bad_proof3[3][0] + 1;
        expect((0, ring_1.NIZK_DLOG_verify_proof)(bad_proof3[0], bad_proof3[1], bad_proof3[2], bad_proof3[3])).toBe(false);
        expect(() => (0, ring_1.NIZK_DLOG_verify_proof)(bad_proof3[0], bad_proof3[1], bad_proof3[2], new Uint8Array(32))).toThrow('expected valid scalar: 1 <= n < 52435875175126190479447740508185965837690552500527637822603658699938581184513, got 0');
    });
});
